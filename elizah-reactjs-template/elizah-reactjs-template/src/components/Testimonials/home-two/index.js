...
import testimonialBg from '../../../assets/images/testimonial2.jpg' 
    ...
    const Testimonials = () => {
        ...
        return (
            ...
            <section className="testimonials-section testimonials_sec_v2" id="testimo" style={{backgroundImage: `url("${testimonialBg}")`}} > 
